...
function App() {
  ...
  useEffect(() => {
    const loadCovidData = async () => {
      try {
        ...
        // fetchCovidData will return fallback data on error
        const fallbackData = await fetchCovidData();
        setCovidData(fallbackData);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Data loaded from backend API. Last updated:{" "}
